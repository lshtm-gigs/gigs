...
curve <- ggplot2::ggplot() +
  ggplot2::geom_ribbon(data = long_tbl, mapping = ggplot2::aes(x = gest_age, ymax = sm(SD3),    ymin = sm(SD2)), alpha = 0.6, fill = "#ffdab9") +
  ggplot2::geom_ribbon(data = long_tbl, mapping = ggplot2::aes(x = gest_age, ymax = sm(SD2),    ymin = sm(SD1)), alpha = 0.6, fill = "#ff8c00") +
  ggplot2::geom_ribbon(data = long_tbl, mapping = ggplot2::aes(x = gest_age, ymax = sm(SD1),    ymin = sm(SD0)), alpha = 0.8, fill = "#fe5a1d") +
  ggplot2::geom_ribbon(data = long_tbl, mapping = ggplot2::aes(x = gest_age, ymax = sm(SD0),    ymin = sm(SD1neg)), alpha = 0.8, fill = "#fe5a1d") +
  ggplot2::geom_ribbon(data = long_tbl, mapping = ggplot2::aes(x = gest_age, ymax = sm(SD1neg), ymin = sm(SD2neg)), alpha = 0.6, fill = "#ff8c00") +
  ggplot2::geom_ribbon(data = long_tbl, mapping = ggplot2::aes(x = gest_age, ymax = sm(SD2neg), ymin = sm(SD3neg)), alpha = 0.6, fill = "#ffdab9") +
