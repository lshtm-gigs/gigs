...
You can install gigs using the `remotes` package, provided you're using a
version of R which is equal to or more recent than R 4.1.0:
```r
# install.packages("remotes")
remotes::install_github("lshtm-gigs/gigs")
```
