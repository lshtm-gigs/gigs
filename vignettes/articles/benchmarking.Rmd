...
functions for a set of growth standards, and an exclamation mark/warning sign
(`r half`) indicates that some standards in a set are implemented, but not others.
...
quicker, it does induce some degree of imprecision when compared to the other
packages.

Next fastest was the `growthstandards` package was the fastest at
...
much slower than the other 'fast' packages, but appears to scale more
efficiently.
