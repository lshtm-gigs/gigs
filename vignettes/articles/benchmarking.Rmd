...
```{r plot_timings_who_gs, echo = FALSE, alt.text = "A line graph of median time taken against no. of inputs for different software packages. The results can be read about below."}
...
inputs. This is mainly because `anthro` computes results in every WHO Child
...
```{r plot_timings_who_gs_faster, echo = FALSE, alt.text = "A line graph of median time taken against no. of inputs for a faster subset of the software packages analysed. The results can be read about below."}
bp_who_gs |>
  dplyr::filter(desc %in% c("gigs", "childsds", "gs", "AGD")) |>
  plot_bp()
```
...
(~`r max_median(bp_who_gs, "childsds")` ms). Interestingly, `AGD` starts out
much slower than the other three packages, but appears to scale more
efficiently.
...
```{r plot_timings_ig_nbs, echo = FALSE, alt.text = "A line graph of median time taken against no. of inputs for the analysed software packages in the INTERGROWTH-21st Newborn Size standard for weight-for-gestational age. The results can be read about below."}
...
```{r plot_timings_ig_png, echo = FALSE, alt.text = "A line graph of median time taken against no. of inputs for the analysed software packages in the INTERGROWTH-21st Postnatal Growth standard for weight-for-age. The results can be read about below."}
...
```{r plot_timings_ig_fet, echo = FALSE, alt.text = "A line graph of median time taken against no. of inputs for the analysed software packages in the INTERGROWTH-21st Fetal standard for occipito-frontal diameter-for-gestational age. The results can be read about below."}
