...
vignette: >
  %\VignetteIndexEntry{INTERGROWTH-21<sup>st</sup> Body Composition Equations}
...
to generate their centiles. To implement these standards in our package, we needed to re-derive these values, in this
case using the published data to work back to linear equations.
