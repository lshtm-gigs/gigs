...
90<sup>th</sup> percentiles are used as the size for GA cut-offs, but some
publications also specify severely small-for-GA newborns as those below the
third weight-for-GA percentile. Whether you do this depends on the `severe`
...
classify_wasting(
  ...
  gest_days = c(268, 247, 250, 278), # c(38 + 2/7, 35 + 2/7, 35 + 5/7, 39 + 5/7) * 7,
