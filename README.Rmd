...
#' srr-tags-readme
#'
#' @srrstats {G1.1} Addressed existence of other packages/implementations in section on 'Other packages'.
```
...
standards and outputs from the `r intergrowth21st` project. You will
...
* `ig_fet` - `r intergrowth21st` Fetal Growth standards
  <details><summary>Component standards</summary>
...
### Terminology
```{r srr-stats-2, eval = FALSE, echo = FALSE}
...
| Software        | Platform | WHO (0-5 years) | `r ig21st` NBS | `r ig21st` PNG | Functionality                     |
|-----------------|----------|-----------------|----------------|----------------|-----------------------------------|
| `r gigs_r`      | R        | `r yes`         | `r yes`        | `r yes`        | Values `r harr` z-scores/centiles |
| `r anthro`      | R        | `r yes`         | `r no`         | `r no`         | Values `r rarr` z-scores          |
| `r childsds`    | R        | `r yes`         | `r no`         | `r no`         | Values `r rarr` z-scores/centiles |
| `r growthstans` | R        | `r yes`         | `r yes`        | `r no`         | Values `r harr` z-scores/centiles |
| `r intergrowth` | R        | `r no`          | `r no`         | `r no`         | NA                                |
| `r gigs_stata`  | Stata    | `r yes`         | `r yes`        | `r yes`        | Values `r harr` z-scores/centiles |
| `r zanthro`     | Stata    | `r yes`         | `r no`         | `r no`         | Values `r rarr` z-scores/centiles |
...
Parker S (2023). _gigs: Assess Growth in Infants and Newborns_.
