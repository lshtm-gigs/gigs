...
* A *centile* represents the proportion of measurements which we would expect to
  be lower than a measurement we've taken, represented as a value between 0 and
  1.
