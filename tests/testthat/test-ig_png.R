...
test_that(
  ...
  code = {
    ...
    for (fn_suffix in fn_suffixes) {
      ...
      # Bad input 5: Invalid `acronym` values (not in names(gigs::ig_png))
      out <- gigs_fn(arg_zyp,
                     arg_x,
                     arg_sex,
...
test_that(
  ...
  code = {
    ...
    for (fn_suffix in fn_suffixes) {
      ...
      # Bad input 6: Invalid `acronym` values (not in names(gigs::ig_png))
      expect_warning(
        gigs_fn(arg_zyp,
                arg_x,
                arg_sex,
      ...
      for (seed in c(125, 175, 225)) {
        ...
        expect_error(
          ...
          regexp = paste0("Variable 'acronym': All elements were invalid. ",
                          "See the 'ig_png' documentation for valid 'acronym' ",
                          "values.")
        )
      }
    }
