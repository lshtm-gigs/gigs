...
# test_that(
#   desc = "Correct errors occur with data of wrong length/type':",
#   code = {
...
#                          arg_x,
#                          arg_sex,
#                          rep_len(arg_acronym, 5)),
#         regexp = test_error_acronym_not_scalar(length = 5)
#       )
#       # G5.2 --> Function halts because `x` is too long, does not reach
#       #          `acronym` error
#       expect_error(
#         object = gigs_fn(arg_zyp,
#                          rep_len(arg_x, 2),
